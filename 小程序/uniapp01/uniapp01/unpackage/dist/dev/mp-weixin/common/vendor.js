...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"uniapp01","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
exports.default = void 0;
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 25));
var _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 105));
var _cart = _interopRequireDefault(__webpack_require__(/*! ./modules/cart.js */ 107));
...
var mutations = {
  addGoodsMutations: function addGoodsMutations(state, goods) {
    ...
    if (item) {
      ...
      _vue.default.set(goods, "isSelected", true);
      _vue.default.set(goods, "buyCount", 1);
      state.cartList.push(goods);
    }
  },
  changeCountMutations: function changeCountMutations(state, _ref) {
  ...
  changeSelectedMutations: function changeSelectedMutations(state, _ref2) {
    var isSelected = _ref2.isSelected,
      index = _ref2.index;
    console.log(isSelected + " changeSelectedMutations ," + index);
    state.cartList[index].isSelected = !isSelected;
  },
  changeAllSelectedMutations: function changeAllSelectedMutations(state, allSelected) {
...
var getters = {
  isAllSelected: function isAllSelected(state) {
    console.log(state.cartList.every(function (item) {
